...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [self.btnCancel setTitleColor:UIColorFromRGB(0x87cee0) forState:UIControlStateNormal];
        ...
        [self.btnOK setTitleColor:UIColorFromRGB(0x87cee0) forState:UIControlStateNormal];
        ...
        self.vTop.backgroundColor = UIColorFromRGB(0xf3f3f3);
